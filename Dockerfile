...
# Use domestic mirrors for faster downloads in China
...
RUN python3 -m pip install -U 'mineru[core]>=3.4.0' --break-system-packages -i https://mirrors.aliyun.com/pypi/simple/ && \
